...
public class CustomSearchUtils {
	...
	public static Search genereateSearchObjectForEmails(String searchTerm,Date startDate, Date endDate, SortField sortField) {
		Search search = generateSearchTerms(searchTerm, Arrays.asList("user.lastName","user.firstName"));
